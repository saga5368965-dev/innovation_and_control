...
import inovation_and_control.inovation_and_control.item.*;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<PrimitiveBookItem> PRIMITIVE_BOOK = ITEMS.register("primitive_book",
            () -> new PrimitiveBookItem(new Item.Properties()));
